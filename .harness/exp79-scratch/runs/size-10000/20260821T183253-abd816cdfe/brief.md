...
No live dispatch claims at 2026-08-21T18:32:53.957465+00:00.
...
Do not remove existing lines. Do not edit any other file. If recall shows an in-flight claim on this file, say so in one sentence before editin`

### `capability.gap` @ `2026-08-21T21:19:13.872872+00:00`

- **v**: `1`
- **ts**: `2026-08-21T21:19:13.872872+00:00`
- **event**: `capability.gap`
- **actor**: `agent.test`
- **data**:
```json
{
  "asked": "synthetic gap 9981",
...
### `work_item.completed` @ `2026-08-21T21:19:14.872881+00:00`

- **v**: `1`
- **ts**: `2026-08-21T21:19:14.872881+00:00`
- **event**: `work_item.completed`
- **actor**: `consilient.dispatch`
- **data**:
```json
{
  "ticket": "dispatch:synth-09982"
}
```

### `work_item.opened` @ `2026-08-21T21:19:15.872885+00:00`

- **v**: `1`
- **ts**: `2026-08-21T21:19:15.872885+00:00`
...
```json
{
  ...
  "run_id": "synth-09983",
  "text": "Synthetic in-flight work item 9983 on shared/coordination.txt",
  "ticket": "dispatch:synth-09983"
}
```
...
_9981 event(s) omitted to fit character limit of 8000._
