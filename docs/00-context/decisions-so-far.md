...
Status key: **DECIDED** (Joe stated it) · **PROPOSED** (Claude argued it, Joe agreed) ·
**PROPOSED-UNCONFIRMED** (Claude argued it, not yet explicitly accepted) ·
...
|---|---|---|---|---|
| D1 | Build a **meta-harness** above existing agents, not a standalone harness | DECIDED | Joe: "your definition of meta harness is correct and what I want to do" | Adapter surface across the four target CLIs turns out to be unmaintainable (Q5) |
...
| D4 | **β (verifier false-accept rate) is the organising parameter** | PROPOSED-UNCONFIRMED | `findings.md` §1–§2, §5 | Q1 (not novel), Q2 (not measurable), Q3 (bimodal difficulty) |
...
| D6 | **No learned routing policy** in v0 | PROPOSED | `findings.md` §4: ~5k trajectories to merely match a fixed policy | Escalation wall-clock cost turns out ≥2× (§4a) |
| D7 | **No trajectory-corpus moat** | PROPOSED | Follows D6 and D2 | — |
| D8 | Communication via a **native agent-first ticket store**; git-backed or SQLite undecided | DECIDED (native) / OPEN (substrate) | Joe stated native; substrate is Q6 | — |
