...
The working tree was dirty and changed during the audit, so “seventeen” means these exact working-tree blobs captured while repository HEAD was `6cd6c940d4e9`: `action-surface` `f7044d4ae0d4`, `autonomy-and-friction` `dee8848ea11a`, `chat-conversation` `e5d5e5301af2`, `chat-delivery` `44ec815d9339`, `consilience-gate` `708736f76bb7`, `decision-protocol` `bbf4cfe7d299`, `evidence-fusion` `070dc581c161`, `expertise-acquisition` `a16aa796eca8`, `living-documentation` `66a91db2438a`, `memory-and-capability` `54ee4b7b9436`, `model-lifecycle` `26bdac3e3c86`, `observability-and-steering` `8125ac29bb83`, `portable-capability` `5471bcfe9b7c`, `self-improvement` `903dee5e9338`, `squad-roles` `bacf9da384c4`, `task-management` `6f09f13f2543`, and `verdict-supply` `48851185672d`; every short name expands under `docs/superpowers/specs/2026-08-22-*.md`, and every digest is a `git hash-object` blob identity. `[measured]` HEAD moved again during validation while all seventeen blob identities remained unchanged, so the blobs—not the moving branch tip—define the population. `[measured]`
