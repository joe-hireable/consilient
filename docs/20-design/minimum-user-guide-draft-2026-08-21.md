...
material handed to arm A of EXP-75. It is a **draft under test**, not approved documentation.
...
- **Under test, not settled.** EXP-75 measures whether an operator holding only this page can
  complete seven core tasks; EXP-76 measures whether collapsing five evidence tags into "checked"
...
- **The one-sided rule applies.** If a simulated operator fails with this page, that is evidence a
  ...
  reported as one. Only EXP-77 can lift that.
